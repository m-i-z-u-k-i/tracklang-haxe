...
::Operators_obj::__register();
::SimpleKeywords_obj::__register();
::BlockOpeners_obj::__register();
...
::BlockOpeners_obj::__boot();
::SimpleKeywords_obj::__boot();
::Operators_obj::__boot();
}
